...
+-------------------------------------------------------------------------------+--------------------+
| **Finding 1: No Consolidated IT/OT Asset Inventory or Unified Risk Register** | **RISK RATING**    |
|                                                                               |                    |
| *Domain: Asset & Risk Management (NIST CSF: Identify)*                        | **CRITICAL**       |
+===============================================================================+====================+
+-------------------------------------------------------------------------------+--------------------+
...
+-------------------------------------------------------------------------------------------------------------+--------------------+
| **Finding 2: Fragmented Identity & Access Management with Poorly Inventoried Third-Party OT Remote Access** | **RISK RATING**    |
|                                                                                                             |                    |
| *Domain: Access & Vendor Risk (NIST CSF: Protect / Govern)*                                                 | **CRITICAL**       |
+=============================================================================================================+====================+
+-------------------------------------------------------------------------------------------------------------+--------------------+
...
+-------------------------------------------------------------------------------------------+--------------------+
| **Finding 3: Reactive, Non-Risk-Based Patch and Vulnerability Management for OT Systems** | **RISK RATING**    |
|                                                                                           |                    |
| *Domain: Vulnerability Management (NIST CSF: Protect)*                                    | **HIGH**           |
+===========================================================================================+====================+
+-------------------------------------------------------------------------------------------+--------------------+
...
+-----------------------------------------------------------------------------------------------------+--------------------+
| **Finding 4: Incident Detection & Regulatory Reporting Capability Insufficient for NIS2 Timelines** | **RISK RATING**    |
|                                                                                                     |                    |
| *Domain: Incident Response (NIST CSF: Detect / Respond)*                                            | **HIGH**           |
+=====================================================================================================+====================+
+-----------------------------------------------------------------------------------------------------+--------------------+
