...
Helios Grid Utilities --- Frankfurt, Germany \| Regional Electricity Distribution Operator
  ...
  -------------------- ------------------------------------ ------------------ ----------------------------------
  **Document Owner**   GRC Analyst, Helios Grid Utilities   **Approved By**    CISO (pending sign-off)

  **Scope**            Corporate IT + OT/ICS/SCADA          **Review Cycle**   Quarterly, or on material change

  **Frameworks**       NIST CSF 2.0, IEC 62443              **Drivers**        NIS2, KRITIS/BSI, ISO 27001

  **Version**          v1.0 --- Draft, Post-Audit Remediation Deliverable   **Date**           20 July 2026
  -------------------- ------------------------------------ ------------------ ----------------------------------
